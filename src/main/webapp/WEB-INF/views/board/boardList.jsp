...
<%@ page
	import="java.util.ArrayList, com.kh.spring.board.model.vo.Board, com.kh.spring.common.model.vo.PageInfo"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<script>
		<!-- 게시글 목록 행을 클릭했을 때 detail 요청을 하도록 -->
		$(function() {
			$("#boardList>tbody>tr").click(function() {
				location.href= 'detail?boardNo=' + $(this).children(".bno").text();
			});
		});
